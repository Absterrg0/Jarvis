...
export class JarvisVoiceInvalidInputError extends Schema.TaggedError<JarvisVoiceInvalidInputError>()(
...
export class JarvisVoiceUnavailableError extends Schema.TaggedError<JarvisVoiceUnavailableError>()(
...
export class JarvisVoiceRuntimeError extends Schema.TaggedError<JarvisVoiceRuntimeError>()(
