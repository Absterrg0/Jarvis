...
Run with stdlib only (no torch/onnxruntime needed):
  python3 scripts/circe-extract/test_roles_v08.py
  python3 -m pytest scripts/circe-extract/test_roles_v08.py -q
...
class SidecarCompat(unittest.TestCase):
    ...
    def test_verify_actions_requires_known_13(self):
        ...
        v077 = "/home/abstergo/.local/share/circe-experiments/extract-v07/v077-small-s7/actions.json"
        if os.path.exists(v077):
            with open(v077) as f:
                self.assertEqual(len(inference_mod.verify_actions(json.load(f))), 13)
        v077_bio = "/home/abstergo/.local/share/circe-experiments/extract-v07/v077-small-s7/bio_labels.json"
