"""Train + export the supervised Circe command extractor. TRAINING ONLY.
...
outdir outside Git):
  ...
  /home/abstergo/.local/share/circe-experiments/extract-v07/train-env/bin/python \\
    scripts/circe-extract/train.py \\
    --data-dir /tmp/opencode/circe-v08-data \\
    --out /tmp/opencode/circe-v08-out/v08-small-s7 \\
...
Recovery without retraining:
  /home/abstergo/.local/share/circe-experiments/extract-v07/train-env/bin/python \\
    scripts/circe-extract/train.py --export-only \\
    --out /home/abstergo/.local/share/circe-experiments/extract-v08/v08-small-s7 \\
    --revision 606e4d55252882ac25ba1f1d1a182075830f5a90
...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(
        description="Train the roles-v1 Circe extractor (BERT-Small, 2 CPU, <2.5GiB).")
    ap.add_argument("--data-dir", default="/tmp/opencode/circe-extract/data")
    ap.add_argument("--out", default="/tmp/opencode/circe-extract/models/extract-v1")
