"""Deployment inference for the supervised Circe command extractor.
...
Contract (data lane owns the dataset; this file only reads its output):
  ...
  packages/circe-core/src/extraction.ts). Label schema roles-v1:
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Run the Circe extractor ONNX model.")
