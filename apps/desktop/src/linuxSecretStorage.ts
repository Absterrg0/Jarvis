...
function getGnomeKeyringRemediationMessage(): string {
  return "The desktop app could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart the desktop app.";
}

function getKWalletRemediationMessage(): string {
  return "The desktop app could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart the desktop app.";
}
