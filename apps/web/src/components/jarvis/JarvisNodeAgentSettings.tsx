...
export function JarvisNodeAgentSettings({
  ...
  const liveVoice = config?.settings.jarvisLiveVoice;
  ...
  return (
    <details className="jarvis-node-settings">
      ...
      <div className="jarvis-node-settings__body">
        ...
        <section className="mt-8 min-w-0" aria-label="Jarvis semantic supervisor">
          <div className="min-w-0">
        ...
        <section className="mt-8 min-w-0" aria-label="Jarvis live voice">
          <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
