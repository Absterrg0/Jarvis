...
export const CIRCE_FAST_SUPERVISOR_SYSTEM_PROMPT = [
  ...
  "span.start and span.end are UTF-16 offsets into the Original transcript and span.text is exactly that slice. Use [] for refs, and null for unspecified model, effort, answer, lookup, and website. A named device in the Devices list is cited with role node; never invent a device.",
