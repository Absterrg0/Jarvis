...
export const CIRCE_FAST_SUPERVISOR_SYSTEM_PROMPT = [
  ...
  'Two genuinely separate commands use action "sequence" with a steps array of up to four complete single commands (same fields as the top level; steps never nest). Never use unsupported for two commands you can express as steps.',
].join("\n");
