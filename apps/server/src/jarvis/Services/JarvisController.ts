...
export class JarvisProjectNotFoundError extends Schema.TaggedError<JarvisProjectNotFoundError>()(
 ...
 * receipt-backed task.
 */
export class JarvisRequestConflictError extends Schema.TaggedError<JarvisRequestConflictError>()(
