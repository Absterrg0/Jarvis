...
@media (prefers-reduced-motion:reduce){.presence-orb,.presence-halo,.orb-current,.orb-caustic,body[data-state="speaking"] .presence-orb{animation:none!important}.field select,.field input{transition:none}}
